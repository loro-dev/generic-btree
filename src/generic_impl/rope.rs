...
impl Query for Finder {
    ...
    fn find_element(&mut self, _: &Self::QueryArg, elements: &[Self::Elem]) -> crate::FindResult {
    ...
    fn delete_range<'x, 'b>(
        ...
        _: &'b Self::QueryArg,
        from: Option<crate::QueryResult>,
        to: Option<crate::QueryResult>,
        ...
        fn drain_end(end: crate::QueryResult, elements: &mut [String]) -> usize {
            let end = if elements[end.elem_index].len() == end.offset {
                end.elem_index + 1
...
mod test {
    ...
    fn test() {
        ...
        rope.insert(0, "1".to_string());
        rope.insert(1, "2".to_string());
        rope.insert(2, "3".to_string());
